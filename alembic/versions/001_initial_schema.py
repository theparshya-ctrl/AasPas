"""Initial schema — all Phase 1 modules.
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_shops_slug"), "shops", ["slug"], unique=False)
    ...
    op.create_index(op.f("ix_locations_shop_id"), "locations", ["shop_id"], unique=False)
