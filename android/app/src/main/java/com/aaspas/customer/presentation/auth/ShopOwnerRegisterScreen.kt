...
@Composable
fun ShopOwnerRegisterRoute(
    onBack: () -> Unit,
    onLoginClick: () -> Unit,
    onRegisterSuccess: () -> Unit,
) {
    val app = LocalContext.current.applicationContext as AasPasApplication
    val viewModel: ShopOwnerRegisterViewModel = viewModel(
        factory = ShopOwnerRegisterViewModelFactory(app.authRepository),
    )
...
fun ShopOwnerRegisterScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.shop_owner_register_title)) },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.shop_owner_register_subtitle),
            ...
            Button(
                ...
                if (uiState.status == RegisterStatus.Loading) {
                    ...
                    Text(stringResource(R.string.shop_owner_register_submit))
                }
            }
